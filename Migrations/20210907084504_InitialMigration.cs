        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultWordlist = table.Column<bool>(type: "bit", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WordListRowId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WordId = table.Column<int>(type: "int", nullable: false),
                    WordlistId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordlistRows", x => x.WordListRowId);
                    table.ForeignKey(
                        name: "FK_WordlistRows_Wordlists_WordlistId",
                        column: x => x.WordlistId,
                        principalTable: "Wordlists",
                        principalColumn: "WordlistId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WordlistRows_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordlistRows_WordId",
                table: "WordlistRows",
                column: "WordId");

            migrationBuilder.CreateIndex(
                name: "IX_WordlistRows_WordlistId",
                table: "WordlistRows",
                column: "WordlistId");
